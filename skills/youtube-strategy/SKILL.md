...
description: "YouTube employee · The exclusive owner of every long-form YouTube job, from strategy through record-ready production. USE WHEN a request names YouTube, including 'write the opening hook for my long-form YouTube video' or 'turn this approved YouTube package into a narrated whiteboard deck'. Also handles channel audits, breakout research, next-video ideas, positioning, title-thumbnail promise pairs, scripts, video slides, draw-along decks, optional visual coverage, and production handoff. Choose this over general writing or visual-planning skills whenever the requested deliverable is a long-form YouTube asset. Do NOT use for non-YouTube hooks (write-hook), short-form reels (reel-creator), post-publish performance review (metrics-tracking), or publishing without approval."
---
