...
- *"read `references/foo.md`"* → `get_skill(skill_id="writing-voice", path="references/foo.md")`
- *"load `workflows/bar.md`"* → `get_skill(skill_id="writing-voice", path="workflows/bar.md")`
