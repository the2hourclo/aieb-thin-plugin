...
- *"read `references/foo.md`"* → `get_skill(skill_id="meta-create-mcp", path="references/foo.md")`
- *"load `workflows/bar.md`"* → `get_skill(skill_id="meta-create-mcp", path="workflows/bar.md")`
