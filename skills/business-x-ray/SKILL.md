...
- *"read `references/foo.md`"* → `get_skill(skill_id="business-x-ray", path="references/foo.md")`
- *"load `workflows/bar.md`"* → `get_skill(skill_id="business-x-ray", path="workflows/bar.md")`
