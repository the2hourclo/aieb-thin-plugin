...
- *"read `references/foo.md`"* → `get_skill(skill_id="writing-logic", path="references/foo.md")`
- *"load `workflows/bar.md`"* → `get_skill(skill_id="writing-logic", path="workflows/bar.md")`
