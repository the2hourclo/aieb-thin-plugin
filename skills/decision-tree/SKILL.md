...
- *"read `references/foo.md`"* → `get_skill(skill_id="decision-tree", path="references/foo.md")`
- *"load `workflows/bar.md`"* → `get_skill(skill_id="decision-tree", path="workflows/bar.md")`
