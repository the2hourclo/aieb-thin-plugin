...
- *"read `references/foo.md`"* → `get_skill(skill_id="meta-create-agent", path="references/foo.md")`
- *"load `workflows/bar.md`"* → `get_skill(skill_id="meta-create-agent", path="workflows/bar.md")`
