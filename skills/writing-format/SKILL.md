...
- *"read `references/foo.md`"* → `get_skill(skill_id="writing-format", path="references/foo.md")`
- *"load `workflows/bar.md`"* → `get_skill(skill_id="writing-format", path="workflows/bar.md")`
