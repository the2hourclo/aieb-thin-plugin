...
- *"read `references/foo.md`"* → `get_skill(skill_id="narrative-gym", path="references/foo.md")`
- *"load `workflows/bar.md`"* → `get_skill(skill_id="narrative-gym", path="workflows/bar.md")`
