...
- *"read `references/foo.md`"* → `get_skill(skill_id="check-setup", path="references/foo.md")`
- *"load `workflows/bar.md`"* → `get_skill(skill_id="check-setup", path="workflows/bar.md")`
