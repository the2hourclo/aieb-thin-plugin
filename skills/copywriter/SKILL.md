---
name: copywriter
description: "Writing employee · Conversion copywriting for offers, sales pages, landing pages, campaigns, email sequences, welcome/onboarding emails, product bullet points, product benefits, sales bullets, VSLs, workshops, and positioning. ALWAYS USE instead of write for 'write bullet points for my product benefits', 'product benefits', 'sales bullets', 'welcome email', 'email sequence', 'sales page', 'landing page copy', 'campaign', 'offer document', 'VSL', 'workshop landing page', 'what should I sell', 'roast my offer', or 'clarify my offer'. Includes campaign blueprint through deployment plus standalone workflows for welcome emails, Product Bullet Points, Agreement Analogy, Offer Clarity, Game Worth Playing, VSL, Workshop Landing Page, Three-Pillar Offer, Rulebook, and offer QA. Do NOT use for a general newsletter, article, daily email, or broadcast email; those route to write."
---
