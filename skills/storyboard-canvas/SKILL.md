...
- *"read `references/foo.md`"* → `get_skill(skill_id="storyboard-canvas", path="references/foo.md")`
- *"load `workflows/bar.md`"* → `get_skill(skill_id="storyboard-canvas", path="workflows/bar.md")`
