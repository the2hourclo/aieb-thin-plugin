...
- *"read `references/foo.md`"* → `get_skill(skill_id="meta-create-command", path="references/foo.md")`
- *"load `workflows/bar.md`"* → `get_skill(skill_id="meta-create-command", path="workflows/bar.md")`
