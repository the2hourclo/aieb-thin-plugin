...
- *"read `references/foo.md`"* → `get_skill(skill_id="writing-humanize", path="references/foo.md")`
- *"load `workflows/bar.md`"* → `get_skill(skill_id="writing-humanize", path="workflows/bar.md")`
