...
- *"read `references/foo.md`"* → `get_skill(skill_id="retrospective", path="references/foo.md")`
- *"load `workflows/bar.md`"* → `get_skill(skill_id="retrospective", path="workflows/bar.md")`
