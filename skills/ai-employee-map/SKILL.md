...
- *"read `references/foo.md`"* → `get_skill(skill_id="ai-employee-map", path="references/foo.md")`
- *"load `workflows/bar.md`"* → `get_skill(skill_id="ai-employee-map", path="workflows/bar.md")`
